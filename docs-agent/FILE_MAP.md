...
| <code>src/components/DocumentToolbar/ZoomButtons.jsx</code> | 541 | 1 | 2 | high | Zoom control cluster: \[ - \] \[ % editable \] \[ + \] \| \[ 1:1 \] \[ Fit Page \] \[ Fit Width \] \[ Custom Fit \] - When the field is NOT focused, it renders like “100%”. |
