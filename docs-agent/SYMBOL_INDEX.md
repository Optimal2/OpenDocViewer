...
| <code>clampNumber</code> | function | <code>src/utils/runtimeConfig.js:177</code> | Clamp a numeric config value to a safe range. |
...
| <code>getPrintDefaultMode</code> | function | <code>src/utils/runtimeConfig.js:424</code> | Resolve the default print page mode used when the user has not stored an override. |
| <code>getPrintSelectionWorkspaceConfig</code> | function | <code>src/utils/runtimeConfig.js:449</code> | Resolve the print-selection workspace configuration. |
...
| <code>getViewerCustomFitSizeLimits</code> | function | <code>src/utils/runtimeConfig.js:400</code> | Resolve the configured custom-size limits. |
| <code>getViewerCustomFitWidthFactorPercent</code> | function | <code>src/utils/runtimeConfig.js:386</code> | Resolve the custom-size width factor percentage. |
| <code>getViewerDefaultZoomMode</code> | function | <code>src/utils/runtimeConfig.js:373</code> | Resolve the initial page zoom mode. |
| <code>getViewerEdgeScrollPageTurnConfig</code> | function | <code>src/utils/runtimeConfig.js:473</code> | Resolve the optional scroll-at-edge page turn gesture. |
| <code>getViewerProblemNoticeConfig</code> | function | <code>src/utils/runtimeConfig.js:491</code> | Resolve the configurable viewer-level problem notice. |
...
| <code>normalizeBoolean</code> | function | <code>src/utils/runtimeConfig.js:156</code> | Normalize a runtime flag to a boolean. |
| <code>normalizeCustomFitSizeLimitPreference</code> | function | <code>src/utils/runtimeConfig.js:347</code> | Normalize the optional user custom-size limits. |
| <code>normalizeCustomFitWidthFactorPercent</code> | function | <code>src/utils/runtimeConfig.js:321</code> | Normalize a custom fit-width factor. |
| <code>normalizeDefaultZoomMode</code> | function | <code>src/utils/runtimeConfig.js:289</code> | Normalize a runtime default zoom mode to the internal DocumentViewer mode. |
| <code>normalizeFloat</code> | function | <code>src/utils/runtimeConfig.js:223</code> | Normalize a floating-point runtime config value and clamp it to the supplied range. |
| <code>normalizeInteger</code> | function | <code>src/utils/runtimeConfig.js:202</code> | Normalize an integer config value and clamp it to the supplied range. |
| <code>normalizeOptionalCustomFitFactorPercent</code> | function | <code>src/utils/runtimeConfig.js:332</code> | Normalize an optional custom-size limit percentage. |
| <code>normalizePrintDefaultMode</code> | function | <code>src/utils/runtimeConfig.js:304</code> | Normalize a user-facing print default mode. |
| <code>normalizeResetSessionFallbackTarget</code> | function | <code>src/utils/runtimeConfig.js:250</code> | Resolve the configured reset-session fallback target. |
| <code>normalizeResetSessionTarget</code> | function | <code>src/utils/runtimeConfig.js:238</code> | Normalize the runtime session-reset target. |
| <code>normalizeZoomModeText</code> | function | <code>src/utils/runtimeConfig.js:264</code> | Normalize a user-facing zoom mode string before alias lookup. |
...
| <code>resolveDefaultZoomModeAlias</code> | function | <code>src/utils/runtimeConfig.js:275</code> | Resolve a normalized zoom-mode alias to the internal viewer mode. |
