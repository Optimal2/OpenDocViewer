...
- Output lines: 119688
- Output characters: 3205671
- Estimated output tokens: 801429

## Largest Output Files

| File | Lines | Characters | Estimated tokens |
| --- | ---: | ---: | ---: |
| `agent-map.json` | 83500 | 2194177 | 548545 |
| `symbol-index.json` | 32459 | 735819 | 183955 |
| `SYMBOL_INDEX.md` | 1279 | 144280 | 36070 |
...
| `chunks/src_components_DocumentViewer.md` | 142 | 7608 | 1902 |
