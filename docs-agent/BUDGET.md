...
- Output lines: 121877
- Output characters: 3305174
- Estimated output tokens: 826303

## Largest Output Files

| File | Lines | Characters | Estimated tokens |
| --- | ---: | ---: | ---: |
| `agent-map.json` | 85095 | 2239262 | 559816 |
| `symbol-index.json` | 32951 | 748590 | 187148 |
| `SYMBOL_INDEX.md` | 1297 | 176465 | 44117 |
