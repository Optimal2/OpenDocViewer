...
- Output lines: 119669
- Output characters: 3205103
- Estimated output tokens: 801287

## Largest Output Files

| File | Lines | Characters | Estimated tokens |
| --- | ---: | ---: | ---: |
| `agent-map.json` | 83483 | 2193631 | 548408 |
| `symbol-index.json` | 32458 | 735704 | 183926 |
| `SYMBOL_INDEX.md` | 1278 | 144192 | 36048 |
